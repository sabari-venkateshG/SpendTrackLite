...
function AuthWrapper({ children }: { children: React.ReactNode }) {
  const { user, loading, isGuest, setGuestMode } = useUser();
      ...
      <div className="flex min-h-screen flex-col items-center justify-center bg-background p-4">
        <div className="flex flex-col items-center gap-4 text-center">
          ...
          <p className="max-w-md text-muted-foreground">
            Sign in to securely save and sync your expenses, or continue as a guest to save data locally on this device.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 mt-4">
            <Button onClick={handleSignIn} size="lg">
             ...
             <Button onClick={() => setGuestMode(true)} size="lg" variant="secondary">
              Continue as Guest
            </Button>
          </div>
        </div>
